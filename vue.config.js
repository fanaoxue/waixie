...
const name = defaultSettings.title || '外协应用' // page title
...
module.exports = {
  ...
  publicPath:
    process.env.VUE_APP_ENV === 'development'
      ? '/'
      : process.env.VUE_APP_ENV === 'staging' || process.env.VUE_APP_ENV === 'prepublish'
        ? '/m_extassist_h5/dist'
        : '//imgt.log56.com/m_extassist_h5/dist', // 基本的url
  outputDir: 'm_extassist_h5/dist',
  assetsDir: 'V3.17.2',
  lintOnSave: false,
